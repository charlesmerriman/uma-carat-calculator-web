		...
		items: [
			{
				...
				answer: [
					<>
						...
						receive an anonymous account reference and nothing else: no email address, no
						real name, no display name, no profile picture, and never a password. Your
						username is randomly generated by us. Alongside that we store the planning
						data you enter, so your plan is there when you come back, and any display
						name or oshis you choose on the Account page.
					</>,
					<>
